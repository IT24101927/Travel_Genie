...
export default function Dashboard({ theme, toggleTheme }) {
  ...
  useEffect(() => {
    ...
    const onFocus = () => { loadTrips().then(doLoadExpenses); loadMyReviews() }
    ...
    <div className="db-page" data-theme={theme}>
      ...
      <nav className="dashboard-nav glass-nav">
        <div className="nav-container">
          <button className="logo" onClick={handleLogout} style={{background:'none',border:'none',cursor:'pointer',padding:0}}><TGLogo /><span>TravelGenie</span></button>
