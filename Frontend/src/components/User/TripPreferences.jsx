...
export default function TripPreferences({ theme, toggleTheme }) {
  ...
  const handleContinue = () => {
    const prefs = { days, tripType, people, hotelType }
      ...
      <div className="tp-body">
          ...
          <div className="tp-col-right">
            ...
            <section className="tp-section tp-days-section">
              <div className="tp-section-header">
                ...
                <div>
                  <h2>How many days?</h2>
                  <p>Choose your total stay duration in {district.name}</p>
                </div>
              </div>
              ...
              <div className="tp-days-control">
                ...
                <div className="tp-days-display">
                  ...
                  <span className="tp-days-unit">{days === 1 ? 'day' : 'days'}</span>
                </div>
                <button
                  className="tp-days-btn"
        ...
        <div className="tp-cta-bar">
          ...
          <div className="tp-summary">
            <span className="tp-summary-chip">🗓️ {days} {days === 1 ? 'day' : 'days'}</span>
