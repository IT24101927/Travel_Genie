...
function AdminDashboard({ theme, toggleTheme }) {
  ...
  const quickActions = [
    ...
    { id: 'tours', icon: '📅', label: 'Itineraries', desc: 'Plan trip itineraries', accent: '#f59e0b' },
          ...
          {!sidebarCollapsed && (
            <div className="ad-sidebar-user">
              ...
              <div className="ad-sidebar-user-info">
                <span className="ad-sidebar-user-name">{currentUser.firstName || 'Admin'} {currentUser.lastName || ''}</span>
            ...
            <div className="ad-overview">
              ...
              <section className="ad-welcome-banner">
                <div className="ad-welcome-text">
                  <h2>{greeting()}, {currentUser.firstName || 'Admin'} 👋</h2>
              ...
              <div className="ad-two-col">
                    ...
                    {recentUsers.map(u => (
                      <div key={u.id} className="ad-user-row">
                        ...
                        <div className="ad-user-meta">
                          <span className="ad-user-name">{u.firstName} {u.lastName}</span>
                ...
                <section className="ad-section ad-card">
                  ...
                  <div className="ad-review-list">
                    ...
                    {recentReviews.map(r => (
                      <div key={r.id} className="ad-review-row">
                        <div className="ad-review-stars">
                          {'★'.repeat(r.rating || 0)}{'☆'.repeat(5 - (r.rating || 0))}
                        </div>
                        <p className="ad-review-comment">{r.comment?.slice(0, 80)}{r.comment?.length > 80 ? '…' : ''}</p>
                        <span className="ad-review-author">
                          {r.User ? `${r.User.firstName} ${r.User.lastName}` : 'Anonymous'} &bull; {r.Destination?.name || r.Place?.name || ''}
                        </span>
                      </div>
                    ))}
                  </div>
